        ...
        <>
            ...
            <div className="bg-[#F1F1F1] py-10 mt-8">
                ...
                <div className='2xl:w-4/5 3xl:w-4/5 lg:w-[46rem] xl:w-3/4 p-6 bg-white rounded-lg shadow-lg ml-[16rem]'>
                    <div className="grid grid-cols-1 2xl:gap-4 3xl:gap-4 xl:gap-4 lg:gap-4 px-2 pt-[2rem] pb-[10rem] rounded-lg md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 3xl:grid-cols-6">
